...
const text = [
    {
        ...
        para2: "Maecenas lobortis ligula vel tellus sagittis ullamcorper vestibulum pellentesque cursus. Maecenas lobortis ligula vel tellus sagittis ullamcorper.",
    },
    {
